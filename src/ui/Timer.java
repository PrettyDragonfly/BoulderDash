...
public class Timer extends Observable {
	...
	/**
	 * Constructeur d'un timer à partir d'une durée exprimée en secondes. Tous
	 * les laps de temps, l'évnement EventTimer est déclenché, et lui-même
	 * notifie à tous ses observateurs
	 *
